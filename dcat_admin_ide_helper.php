...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection ent_id
     * @property Grid\Column|Collection add_id
     ...
     * @method Grid\Column|Collection ent_id(string $label = null)
     * @method Grid\Column|Collection add_id(string $label = null)
     ...
     * @property Show\Field|Collection ent_id
     * @property Show\Field|Collection add_id
     ...
     * @method Show\Field|Collection ent_id(string $label = null)
     * @method Show\Field|Collection add_id(string $label = null)
